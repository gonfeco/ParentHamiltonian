...
def pauli_decomposition(array, dimension, jobs=-1):
    ...
    coefs : list
        Coeficients of the different Pauli matrices decomposition
    strings_pauli : list
    ...
    #The dimension of the sqare matrix
    #dimension = array.shape[0]

    strings_pauli = []
    coefs = []
    # Here we compute all posible pauli combinations
    ...
    # posible kronecker product of Pauli matrices. This here we compute
    # the coefficients of the array in the basis of the correspondent
    # dimension kronecker product Pauli matrices.
    # This part can be very demanding so we try to paralelize as much
    # as we can.
    combinations = it.product([0, 1, 2, 3], repeat=dimension)
